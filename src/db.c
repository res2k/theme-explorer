...
/* DWMWindow 
   ...
   FIXME: These parts work for Windows 7, but mismatch for later versions...
 */
static const db_part_t db_parts_DWMWINDOW[] = {
    DB_DEFINE_PART_EMPTY(1,   1,  FrameBottomActive),
    DB_DEFINE_PART_EMPTY(2,   2,  FrameShadow),
    DB_DEFINE_PART_EMPTY(3,   3,  MaxButtonActive),
    DB_DEFINE_PART_EMPTY(4,   4,  MaxButtonInactive),
    DB_DEFINE_PART_EMPTY(5,   5,  MinButtonActive),
    DB_DEFINE_PART_EMPTY(6,   6,  MinButtonInactive),
    DB_DEFINE_PART_EMPTY(7,   7,  CloseButtonActive),
    DB_DEFINE_PART_EMPTY(8,   8,  CloseButtonInactive),
    DB_DEFINE_PART_EMPTY(9,   9,  CloseButtonAloneActive),
    DB_DEFINE_PART_EMPTY(10, 10,  CloseButtonAloneInactive),
    DB_DEFINE_PART_EMPTY(11, 11,  CloseButtonGlow),
    DB_DEFINE_PART_EMPTY(12, 12,  CloseButtonGlyph1),
    DB_DEFINE_PART_EMPTY(13, 13,  CloseButtonGlyph2),
    DB_DEFINE_PART_EMPTY(14, 14,  CloseButtonGlyph3),
    DB_DEFINE_PART_EMPTY(15, 15,  CloseButtonGlyph4),
    DB_DEFINE_PART_EMPTY(16, 16,  MinMaxButtonGlow),
    DB_DEFINE_PART_EMPTY(17, 17,  HelpButtonGlyph1),
    DB_DEFINE_PART_EMPTY(18, 18,  HelpButtonGlyph2),
    DB_DEFINE_PART_EMPTY(19, 19,  HelpButtonGlyph3),
    DB_DEFINE_PART_EMPTY(20, 20,  HelpButtonGlyph4),
    DB_DEFINE_PART_EMPTY(21, 21,  MaxButtonGlyph1),
    DB_DEFINE_PART_EMPTY(22, 22,  MaxButtonGlyph2),
    DB_DEFINE_PART_EMPTY(23, 23,  MaxButtonGlyph3),
    DB_DEFINE_PART_EMPTY(24, 24,  MaxButtonGlyph4),
    DB_DEFINE_PART_EMPTY(25, 25,  MinButtonGlyph1),
    DB_DEFINE_PART_EMPTY(26, 26,  MinButtonGlyph2),
    DB_DEFINE_PART_EMPTY(27, 27,  MinButtonGlyph3),
    DB_DEFINE_PART_EMPTY(28, 28,  MinButtonGlyph4),
    DB_DEFINE_PART_EMPTY(29, 29,  RestoreButtonGlyph1),
    DB_DEFINE_PART_EMPTY(30, 30,  RestoreButtonGlyph2),
    DB_DEFINE_PART_EMPTY(31, 31,  RestoreButtonGlyph3),
    DB_DEFINE_PART_EMPTY(32, 32,  RestoreButtonGlyph4),
    DB_DEFINE_PART_EMPTY(33, 33,  FrameLeftRight),
    DB_DEFINE_PART_EMPTY(34, 34,  Part34),
    DB_DEFINE_PART_EMPTY(35, 35,  Part35),
    DB_DEFINE_PART_EMPTY(36, 36,  FrameBottom2),
    DB_DEFINE_PART_EMPTY(37, 37,  FrameLeftRight2),
    DB_DEFINE_PART_EMPTY(38, 38,  Part38),
    DB_DEFINE_PART_EMPTY(39, 39,  FrameTop),
    DB_DEFINE_PART_EMPTY(40, 40,  GlassSheet),
    DB_DEFINE_PART_EMPTY(41, 41,  Part41),
    DB_DEFINE_PART_EMPTY(42, 42,  Part42),
    DB_DEFINE_PART_EMPTY(43, 43,  Part43),
    DB_DEFINE_PART_EMPTY(44, 44,  FrameBottomTool),
    DB_DEFINE_PART_EMPTY(45, 45,  CloseButtonToolActive),
    DB_DEFINE_PART_EMPTY(46, 46,  CloseButtonToolInactive),
    DB_DEFINE_PART_EMPTY(47, 47,  CloseButtonToolGlow),
    DB_DEFINE_PART_EMPTY(48, 48,  CloseButtonToolGlyph1),
    DB_DEFINE_PART_EMPTY(49, 49,  CloseButtonToolGlyph2),
    DB_DEFINE_PART_EMPTY(50, 50,  CloseButtonToolGlyph3),
    DB_DEFINE_PART_EMPTY(51, 51,  CloseButtonToolGlyph4),
    DB_DEFINE_PART_EMPTY(52, 52,  Part52),
    DB_DEFINE_PART_EMPTY(53, 53,  Part53),
    DB_DEFINE_PART_EMPTY(54, 54,  FrameTopTool),
    DB_DEFINE_PART_EMPTY(55, 55,  Part55),
    DB_DEFINE_PART_EMPTY(56, 56,  FrameTop2),
    DB_DEFINE_PART_EMPTY(57, 57,  FrameTopShadow),
    DB_DEFINE_PART_EMPTY(58, 58,  FrameTop3),
    DB_DEFINE_PART_EMPTY(59, 59,  FrameBottom3),
    DB_DEFINE_PART_EMPTY(60, 60,  Part60),
    DB_DEFINE_PART_EMPTY(61, 61,  Part61),
    DB_DEFINE_PART_EMPTY(62, 62,  FrameTop4),
    DB_DEFINE_PART_EMPTY(63, 63,  FrameBottom4),
    DB_DEFINE_PART_EMPTY(64, 64,  Part64),
    DB_DEFINE_PART_EMPTY(65, 65,  Part65),
    DB_DEFINE_PART_EMPTY(66, 66,  FrameTopTool2),
    DB_DEFINE_PART_EMPTY(67, 67,  FrameBottomTool2),
    DB_DEFINE_PART_EMPTY(68, 68,  Spinner),
    DB_DEFINE_PART_EMPTY(69, 69,  SnapIndicator),
    DB_DEFINE_PART_EMPTY(70, 70,  FrameTop5),
    DB_DEFINE_PART_EMPTY(71, 71,  FrameTop6),
};
...
static const db_class_t db_classes_helper[] = {
    ...
    DB_DEFINE_CLASS(DWMWindow,                                         db_parts_DWMWINDOW),
